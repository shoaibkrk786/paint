...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ URL::asset('admin/AdminLTE.min.css')}}">
    <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
          page. However, you can choose any other skin. Make sure you
          apply the skin class to the body tag so the changes take effect.
    -->
    <link rel="stylesheet" href="{{ URL::asset('admin/skin-blue.min.css')}}">
...
<!-- jQuery 2.2.3 -->
<script src="{{ URL::asset('admin/jQuery/jquery-2.2.3.min.js')}}"></script>
<!-- Bootstrap 3.3.6 -->
